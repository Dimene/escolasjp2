...
<table>
    <tbody>
        <?php
         ...
         $total= 0;
        ?>
        <?php $__currentLoopData = $arrayrelatorio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arrayrelatorioItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($conter==4): ?> <?php $conter=1; ?> <?php endif; ?>
<?php
...
?>
        ...
        <?php if( $conter==1): ?>
         ...
         <tr >
             <?php endif; ?>
 <td><hr>
           <b>Mes:</b>    <a href="<?php echo e(Route('mensalidade.Relatoriodetalhado',[$ano,$classe,$arrayrelatorioItem["mesId"]])); ?>"  >
		   <input id="mes"  type="hidden" name='mes<?php echo e($arrayrelatorioItem["mesId"]); ?>' value='<?php echo e($arrayrelatorioItem["mes"]); ?>'
		   numeroAlunos='<?php echo e($arrayrelatorioItem["NrAlunos"]); ?>'
		   tranferencias='<?php echo e($arrayrelatorioItem["tranferencias"]); ?>'
		   disistentes='<?php echo e($arrayrelatorioItem["disistentes"]); ?>'
		   qtdQpagar='<?php echo e($arrayrelatorioItem["qtdQpagar"]); ?>'
		   qtdQNpagar='<?php echo e($arrayrelatorioItem["NrAlunos"]-$arrayrelatorioItem["qtdQpagar"]); ?>'
		   >
           <?php echo e($arrayrelatorioItem["mes"]); ?>

           </a>
           <br>
           <b> Numero de Alunos:</b><?php echo e($arrayrelatorioItem["NrAlunos"]); ?>


 <br>

 <b>Transferências:</b><?php echo e($arrayrelatorioItem["tranferencias"]); ?>


 <br>
           <b>Desistentes:</b><?php echo e($arrayrelatorioItem["disistentes"]); ?>

 <br>
           <b> pagamento de Mensalidades:</b><?php echo e($arrayrelatorioItem["qtdQpagar"]); ?>


           <br>
           <b>Alunos com Multa:</b><?php echo e($arrayrelatorioItem["alunoscommulta"]); ?>

           <br>
           <b>pagamento de multas:</b><?php echo e($arrayrelatorioItem["valorpagodemulta"]); ?>,00 MT
           <br>
           <b>Pagamento de   Mensalidades:</b><?php echo e($arrayrelatorioItem["valorpagoMensalidades"]); ?>,00 MT
           <br>
           <b>Total :</b><?php echo e($arrayrelatorioItem["valorpagoMensalidades"]+$arrayrelatorioItem["valorpagodemulta"]); ?>,00 MT,
...
<tr style="background-color: rgba(0,0,0,0.07);">
    <td>Total de Mensalidades : <?php echo e($totalmensalidades); ?>,00MT
    </td>

 <td>Total de Multas : <?php echo e($totalmulta); ?>,00MT
    </td>

    <td>Total  : <?php echo e($total); ?>,00MT
    </td>
...
<script src="<?php echo e(asset('Admin-LTE/plugins/chartjs-old/Chart.min.js')); ?>"></script>
<!-- AdminLTE App -->
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/relatorio-ano-classe.blade.php ENDPATH**/ ?>