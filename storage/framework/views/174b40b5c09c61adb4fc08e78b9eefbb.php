...
<form id="formExcel" method="get" action="/RegistoAcademico/notas/disciplinas/notasTrimestrais/Imprimir/Pauta/anual/">
    <?php echo csrf_field(); ?>
    ...
    <input type="hidden" name="turma" id="turma">
     <input type="hidden" name="notasdiferente" id="notasdiferente" value="100">
</form>
    </div>
 <?php endif; ?>
...
$size=collect($divisoes)->where('divisao_id', '<>', 100);
   ...
   ( <?php echo e($classe_disciplinasItem->disciplina->Sigla); ?>  )
        ...
        <tr style="background-color:rgba(79, 201, 140, 0.603);border-block-color:rgba(0,0,0,0.128)" id="SegundaLinha">
            <?php $__currentLoopData = $classe_disciplinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyC => $classe_disciplinasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = collect($divisoes)->where('divisao_id', '<>', 100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisoesItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                    <th class="coluna2">
                    <?php echo e($divisoesItem->divisao); ?> NF
        ...
        <?php $__currentLoopData = $coleccaoalunos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $itemI): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr id="<?php echo e($key + 1); ?>" dadosNota="<?php echo e($itemI['id']); ?>"   data-id="<?php echo e($itemI['id']); ?>">
                ...
                <?php $__currentLoopData = $itemI['disciplina']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key0 => $disciplina): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $disciplina['notas']->where("divisao_id","<>",100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $divisoesItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
formula="<?php echo e($formunlamendia->where("TipoMedia",1)->first()->formula??null
 ?? ''); ?>"

<?php echo e($divisoesItem['divisao']); ?>="<?php echo e($divisoesItem['NT']); ?> "

NT="<?php echo e($divisoesItem['divisao']); ?>NF"
  ...
  disciplina="<?php echo e($disciplina['disciplina_id']); ?>"
						...
						<?php echo e(optional($disciplina['notas']->where('divisao_id', '=', 100)->first())['NT'] ?? ''); ?>
    ...
    <?php echo e(optional($mediasanual->where('aluno_classe_id', $itemI['id'])->first())->valor ?? ''); ?>
...
window.precistirbanco = '<?php echo e(route("notas.precistirbanco")); ?>';
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/notas/notas-todoano.blade.php ENDPATH**/ ?>