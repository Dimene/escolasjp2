...
<li class="nav-item has-treeview <?php echo e($isFinancas || $isDashboard ? 'menu-open' : ''); ?>">
    ...
    <ul class="nav nav-treeview">
        <?php if(Gate::check('Dashabord-Financas')): ?>
        ...
        <?php if(Gate::check('Visualizar-Referencias') || Gate::check('Criar-Referencias')): ?>
...
<?php endif; ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/Componetes/menum-GESTAOfINACEIRA.blade.php ENDPATH**/ ?>