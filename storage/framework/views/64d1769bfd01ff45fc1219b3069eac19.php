...
<div class="container-fluid animate-fadeInUp" style="animation-delay: 0.1s;">
    ...
    <?php $__currentLoopData = $tipodepagamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Visualizar-' . trim($tipo->Descricao))): ?>
...
<div class="container-fluid animate-fadeInUp" style="animation-delay: 0.2s;">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <div class="info-box" style="background: <?php echo e($bgColors['primary']); ?>; color: white;">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <div class="info-box" style="background: <?php echo e($bgColors['success']); ?>; color: white;">
                <span class="info-box-icon">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <div class="info-box" style="background: <?php echo e($bgColors['warning']); ?>; color: white;">
                <span class="info-box-icon">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
            <div class="info-box" style="background: <?php echo e($bgColors['info']); ?>; color: white;">
                <span class="info-box-icon">
                    ...
                    <div class="col-md-4">
                        <div class="resumo-card valor visualizarDiariasDetalhes">
                            <div class="resumo-card-title">
                             ...
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Detalhes-Diarias')): ?>
                    ...
                    <div class="col-md-4">
                        <div class="resumo-card valor visualizarMensalDetalhes">
                            <div class="resumo-card-title">
                              ...
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Detalhes-Mensal')): ?>
                            <div class="resumo-card-number">
                    ...
                    <div class="col-md-4">
                        <div class="resumo-card valor visualizarEsperadoDetalhes">
                            <div class="resumo-card-title">
                              ...
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Detalhes-Anual')): ?>
                            <div class="resumo-card-number">
...
let dataTable = null;
let diariasPermissao = <?php echo json_encode(Gate::check('Detalhes-Diarias'), 15, 512) ?>;
let mensalPermissao = <?php echo json_encode(Gate::check('Detalhes-Mensal'), 15, 512) ?>;
let anualPermissao = <?php echo json_encode(Gate::check('Detalhes-Anual'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/home-index.blade.php ENDPATH**/ ?>