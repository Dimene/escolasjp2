            ...
            <div class="card-body p-4">
                ...
                <?php $__currentLoopData = $groupedByClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classeNome => $itemsByClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="class-card mb-4">
                        <div class="class-header" data-class-id="<?php echo e($classUniqueId); ?>">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0"><i class="fas fa-chalkboard-user me-2"></i> <?php echo e($classeNome); ?></h5>
                                <i class="fas fa-chevron-right toggle-icon" data-icon-id="<?php echo e($classUniqueId); ?>"></i>
                            </div>
                        </div>
                        <div id="<?php echo e($classUniqueId); ?>" class="class-content-wrapper">
                            ...
                            <?php $__currentLoopData = $groupedByMethod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metodoNome => $itemsByMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="method-group">
                                    <div class="method-header" data-method-id="<?php echo e($methodUniqueId); ?>">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <i class="fas fa-chevron-down toggle-icon-method ms-2" data-method-icon-id="<?php echo e($methodUniqueId); ?>"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="<?php echo e($methodUniqueId); ?>" class="student-list">
...
</html><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/outrosPagamento/relatoriospagamentos/pagamentos.blade.php ENDPATH**/ ?>