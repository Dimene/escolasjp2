...
<?php $__env->startSection('title', 'Relatorio de pagamentos'); ?>
...
<label>Escolha o tipo de pagamento </label>
            <div class="form-group">
                ...
                onchange="adicionardadostabela()" name="tipodepagamento">
         ...
         var tipo= $('#tipodepagamento').val();
          ...
          var date2 = new Date(data2);
            ...
            console.log(data2send);
                ...
                $.ajax({
                    url:'/RegistoAcademico/outrosPagamento/Relatorio/pagamentos/'+ano+'/'+classe+'/'+data1send+'/'+data2send+'/'+tipo+'',
                    type:'GET',
					...
					beforeSend: function(){
					  $(".conteudo").html(' <img src="<?php echo e(asset('imageproceaament/loading.gif')); ?>"  style=" margin-left:40%;width:200px;height:200px">');
					}
...
var date2 = new Date(data2);
  ...
  console.log(data2send);
      ...
      $.ajax({
          url:'/RegistoAcademico/outrosPagamento/Relatorio/pagamentosPrint/'+ano+'/'+classe+'/'+data1send+'/'+data2send+'/'+tipo,
          type:'GET',
          success: function(data){
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/outrosPagamento/relatoriospagamentos/relatorio-pagamentos-index.blade.php ENDPATH**/ ?>