...
<li class="nav-item has-treeview <?php echo e(Request::is('RegistoAcademico/notas*') ? 'menu-open' : ''); ?>">
    ...
    <ul class="nav nav-treeview">
        ...
        <?php endif; ?>
         ...
         <?php if($direcao ||Gate::check("Configuracoes-Trimestrais")): ?>
        <li class="nav-item">
...
<?php /**PATH C:\laragon\www\escolasaojoaopaulo\resources\views/Componetes/menum-componente-notas.blade.php ENDPATH**/ ?>