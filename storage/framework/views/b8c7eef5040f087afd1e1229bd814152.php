...
<div class="card text-left ">
  ...
  <table id="dadTable" class="table table-striped table-bordered">
    ...
    <tbody>
        <?php if(!empty($dad)): ?>
        <?php $__currentLoopData = $dad->unique('aluno_classe_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dadItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\laragon\www\escolasaojoaopaulo\resources\views/registoAcademico/notas/PainelControlNotasDocunetosConteudo.blade.php ENDPATH**/ ?>