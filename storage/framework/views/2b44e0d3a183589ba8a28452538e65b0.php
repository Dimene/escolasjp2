    ...
    <div class="resumo-body">
        ...
        <div class="mt-3">
            ...
            <button class="btn btn-success w-100" id="confirmarPagamento"
             style="display: none"  idaluno="<?php echo e($dadosTable[0]->aluno_classe_id); ?>">
                <i class="fas fa-check-circle me-2"></i>Confirmar Pagamentos
            </button>
            <button class="btn btn-danger w-100" id="Reverterpagamento"  style="display: none" idaluno="<?php echo e($dadosTable[0]->aluno_classe_id); ?>">
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/outrosPagamento/outrosPagamentos-pagar.blade.php ENDPATH**/ ?>