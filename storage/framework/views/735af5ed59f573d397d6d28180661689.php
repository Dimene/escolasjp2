            ...
            >
                ...
                <div class="table-responsive">
                    ...
                    <table
                        ...
                        class="table table-bordered table-striped tabelaEstado"
                        width="100%"
                    >
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $alunos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aluno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(
                                    Gate::check("Lista-{$tipopagamento}") ||
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <fieldset>
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="<?php echo e(asset('storage/fotoAluno/avatar.png')); ?>" alt=""
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"><label><b>Tipo de saída:</b></label></div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6"><label><b>Mês:</b></label></div>
                                        <div class="col-md-6">
...
<?php /**PATH C:\laragon\www\escola2025\resources\views/registoAcademico/Alunos-inscritos.blade.php ENDPATH**/ ?>