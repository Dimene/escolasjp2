        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="card-modern">
                ...
                <div class="card-body-modern">
                    ...
                    <form method="POST" action="<?php echo e(route('Usuarios.update', $usuario->id)); ?>" enctype="multipart/form-data" id="userForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="avatar-upload">
                            <div class="avatar-preview" onclick="$('#avatarInput').click()">
                                <?php if($usuario->avatar ?? false): ?>
                                    <img id="avatarPreview" src="<?php echo e(asset('storage/' . $usuario->avatar)); ?>" alt="Avatar">
                                <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" name="sexo" required>
                                        ...
                                        <option value="M" <?php echo e(old('sexo', $usuario->sexo ?? '') == 'M' ? 'selected' : ''); ?>>Masculino</option>
                                        <option value="F" <?php echo e(old('sexo', $usuario->sexo ?? '') == 'F' ? 'selected' : ''); ?>>Feminino</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" name="categoria" required>
                                        ...
                                        <?php $__currentLoopData = $categoria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoriaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($categoriaItem->id); ?>"
                                                <?php echo e((isset($usuario->categoria) && $usuario->categoria->contains('id', $categoriaItem->id)) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="anolectivo_id" required>
                                        ...
                                        <?php $__currentLoopData = $anolectivo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anolectivoItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($anolectivoItem->id); ?>"
                                                <?php echo e((isset($usuario->anolectivo) && $usuario->anolectivo->contains('id', $anolectivoItem->id)) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="Nivel" required>
                                        ...
                                        <?php $__currentLoopData = $nivel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nivelItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($nivelItem->id); ?>"
                                                <?php echo e((isset($usuario->Nivel_id) && $usuario->Nivel_id == $nivelItem->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="role" required>
                                        ...
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($role->id); ?>"
                                                <?php echo e((isset($usuario->roles) && $usuario->roles->contains('id', $role->id)) ? 'selected' : ''); ?>>
                                                <?php echo e($role->label); ?>

                                                <?php if($role->permission->count()): ?>
                                                    (<?php echo e($role->permission->pluck('label')->implode(', ')); ?>)
                                                <?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-12 text-right">
                                <a href="<?php echo e(route('Usuarios.index')); ?>" class="btn-secondary-modern">
                                    <i class="fa fa-arrow-left mr-2"></i> Voltar
                                </a>
                                <?php if(isset($trashed)): ?>
                                    <a href="<?php echo e(route('Usuarios.userrestore', $usuario->id)); ?>" class="btn-warning-modern ml-2">
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/auth/edit-usuario.blade.php ENDPATH**/ ?>