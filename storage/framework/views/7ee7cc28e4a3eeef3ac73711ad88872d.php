...
<div class="d-flex justify-content-between align-items-center mb-3">
    <span class="badge bg-primary p-2">
        <?php echo e(count($cabecalho)); ?> Colunas |
        <?php echo e(count($dados)); ?> Registros
    </span>
...
<tr>
<?php $__currentLoopData = $cabecalho; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $th): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <th style="white-space:nowrap;"><?php echo e($th); ?></th>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</tr>
</thead>

<tbody>
<?php $__currentLoopData = $dados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr data-row="<?php echo e($rowIndex); ?>">
<?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colIndex => $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<td contenteditable="true"
    data-row="<?php echo e($rowIndex); ?>"
    data-col="<?php echo e($colIndex); ?>"
    data-original="<?php echo e($cell); ?>"
    <?php if($tipoCampo != 0): ?>
        data-type="<?php echo e($tipoCampo); ?>"
    <?php endif; ?>
...
<?php $__currentLoopData = $religioes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>

<datalist id="distritos">
<?php $__currentLoopData = $distritos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>

<datalist id="provincias">
<?php $__currentLoopData = $provincias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
<datalist id="doencas">
<?php $__currentLoopData = $doencas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>

<datalist id="profissoes">
<?php $__currentLoopData = $profissoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>

<datalist id="graus">
<?php $__currentLoopData = $graus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($Item); ?>">
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>

<datalist id="TipoPagamento">
<?php $__currentLoopData = $metodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    sexo =["M","F"];
    ListaSImNao =["Sim","Não"];
    classe=<?php echo json_encode($classe, 15, 512) ?>;
    datalist=<?php echo json_encode($datalistajs, 15, 512) ?>;
    TipoPagamento=<?php echo json_encode($metodos, 15, 512) ?>;
    tipo=<?php echo json_encode($tipo, 15, 512) ?>;
    cabecalho=<?php echo json_encode($cabecalho, 15, 512) ?>;

var urlUPLOADfILA="<?php echo e(route('aluno.MatriculaFila')); ?>";
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/alunos-inscrito-upload.blade.php ENDPATH**/ ?>