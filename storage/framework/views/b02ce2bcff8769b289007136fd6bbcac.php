...
<div class=" shadow-sm border-0">
    <div class=" bg-white pb-0">
        <ul class="nav nav-tabs nav-tabs-professional" role="tablist">
            <?php $__currentLoopData = $tipo->unique('Descricao'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tipoItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
$i=$i+1;
    ...
    <?php if($canAccess): ?>
                <li class="nav-item">
                    <a class="nav-link menuNivel1 <?php echo e($tipoItem->Descricao ===$arrayposicaoTab1[0] ? 'active' : ''); ?>"
                       data-toggle="tab"
                       href="#pane-<?php echo e($tabId); ?>"
                       role="tab"
                       data-idtipo="<?php echo e($tipoItem->id); ?>">
                        <i class="fa <?php echo e($tipoItem->icon); ?> mr-2"></i>
                        <?php echo e($tipoItem->Descricao); ?>
...
$x=$x+1;
                ...
                ?>
                <?php if($canAccess): ?>
                <div class="tab-pane fade <?php echo e($tipoItem->Descricao ===$arrayposicao[0]  ? 'show active' : ''); ?>"
                     id="pane-<?php echo e($tabId); ?>" role="tabpanel">

                    <!-- SUB ABAS -->
                    <ul class="nav nav-pills nav-pills-soft mb-3">
                        <?php $__currentLoopData = $subItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subIndex => $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item">
                                <a class="nav-link sub-aba <?php echo e($subIndex === 0 ? 'active' : ''); ?>"
                                   data-toggle="tab"
                                   href="#subpane-<?php echo e($tabId); ?>-<?php echo e($item2->mes); ?>"
                                   role="tab"
                                   data-idtipo="<?php echo e($tipoItem->id); ?>"
                                   data-idmes="<?php echo e($item2->mes); ?>"
                                   data-mesdesc="<?php echo e($item2->mesNome); ?>"
                                   data-idano="<?php echo e($item2->anolectivo_id); ?>"
                                   data-tipodesc="<?php echo e($tipoItem->Descricao); ?>"
                                   data-idclasse="<?php echo e($item2->classe_id); ?>">
                                   <?php echo e($item2->mesNome); ?>
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/Componetes/componete-menum-pagamentosMeses.blade.php ENDPATH**/ ?>