                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <datalist id="listaProfissoes">
                                        <?php $__currentLoopData = $profissao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profissaoItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($profissaoItem->Descricao); ?>">
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </datalist>
                                </div>
                            </div>
    ...
    $('#btnLimpar').click(function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $('#formAluno')[0].reset();
                $('#avatar-img').attr('src', '<?php echo e(asset("storage/fotoAluno/avatar.png")); ?>');
                $('.image-tag').val('');
                $('#fileexplorer-label').html('<i class="fas fa-upload"></i> Escolher Foto');
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/matricular-atualizar-dados.blade.php ENDPATH**/ ?>