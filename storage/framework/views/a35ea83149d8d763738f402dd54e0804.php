    ...
    <div class="row ">
        <div class="col-md-12 ">
            ...
            <center>
                <div class="container-fluid">
                    <h3 class="" style="">
                        <strong><?php echo e($conf->nome); ?>

                        </strong>
                    </h3>
                    <p>
                    <h4>Lista Nominal dos Alunos da <?php echo e($alunosturma[0]->classe); ?> Ano de <?php echo e($alunosturma[0]->anolectivo); ?>

                    </h4>
                    </p>
                    <hr>
                    <?php if($tipo==1): ?>
                    <p><b>Turma</b> <?php echo e($alunosturma[0]->turma); ?> </p>
                    <?php else: ?>
                       <p><b>Jurri</b> <?php echo e($alunosturma[0]->jurri); ?> </p>
                    <?php endif; ?>
                    <hr>
                </div>
            </center>
            ...
            <div>
                ...
                <table class="table table-light" width="100%">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $alunosturma; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $alunoclasseTurmaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="border: 1px solid #ddd; padding: 8px;">
                                <td><?php echo e($key + 1); ?></td>
                                <td><?php echo e($alunoclasseTurmaItem->nome); ?></td>
...
<?php /**PATH C:\laragon\www\escola2025\resources\views/registoAcademico/Turma-Lista.blade.php ENDPATH**/ ?>