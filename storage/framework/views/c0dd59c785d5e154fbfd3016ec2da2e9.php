...
<div class="operations-container">
    <div class="operations-card">
        ...
        <?php if(!empty($oberveroperacoes) && count($oberveroperacoes) > 0): ?>
                    ...
                    <tr class="info-row">
                        ...
                        <td width="10%">
                            ...
                            <div class="d-flex align-items-center">
                                <i class="fas <?php echo e($icon); ?> text-primary me-2"></i>
                                <span class="text-truncate" style="max-width: 100px;" title="<?php echo e($value->model ?? 'N/A'); ?>">
                                    <?php echo e($value->model ?? 'N/A'); ?>
                        ...
                        <td width="10%">
                            ...
                            ?>
                            <span class="badge-action <?php echo e($actionClass); ?>">
                        ...
                        <td width="10%">
                            <div class="small">
                                <div class="text-nowrap">
                                    ...
                                    <span title="<?php echo e($value->created_at); ?>" class="fw-semibold">
                                        <?php echo e($value->created_at ? Carbon::parse($value->created_at)->format('d/m/Y') : 'N/A'); ?>

                                    </span>
                                </div>
                                <div class="text-muted" style="font-size: 0.7rem;">
                                    <?php echo e($value->created_at ? Carbon::parse($value->created_at)->format('H:i:s') : ''); ?>
                        ...
                        <td width="10%">
                            ...
                            ?>
                            <div class="d-flex align-items-center">
                                <i class="fas <?php echo e($displayIcon); ?> <?php echo e($hasError ? 'text-danger' : 'text-success'); ?> me-2"></i>
                                <div class="text-truncate" style="max-width: 100px;" title="<?php echo e($displayText); ?>">
                                    <?php if($hasError): ?>
                                        <span class="text-danger"><?php echo e($displayText); ?></span>
                                    <?php else: ?>
...
<?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/Admin/ACL/oberver-lista.blade.php ENDPATH**/ ?>