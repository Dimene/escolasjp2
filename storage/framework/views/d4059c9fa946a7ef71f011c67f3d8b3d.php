<?php $__env->startSection('title', 'Tabela de Valores por Ano Lectivo'); ?>
...
<div class="container-fluid px-0">
    ...
    <ul class="nav nav-tabs">
        <?php $__currentLoopData = $anolectivo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="nav-item">
                <a class="nav-link ano-link <?php if($value->anolectivo == date('Y')): ?> active <?php endif; ?>"
                   href="#"
                   data-ano-id="<?php echo e($value->id); ?>">
                    <i class="fa fa-calendar"></i>
                    <?php echo e($value->anolectivo); ?>

                    <?php if($value->anolectivo == date('Y')): ?>
    ...
    <!-- Conteúdo por Ano -->
    <?php $__currentLoopData = $anolectivo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="ano-content" id="ano-<?php echo e($value->id); ?>"
             style="display: <?php echo e($value->anolectivo == date('Y') ? 'block' : 'none'); ?>;">

            <?php
                $tipos = $dados->where('anolectivo_id', $value->id)->unique('tipo');
            ?>

            <?php if($tipos->where('tipo', '>', 2)->count() > 0): ?>
                <!-- Tabs Tipo -->
                <ul class="nav nav-tabs2 mt-3">
                    <?php $__currentLoopData = $tipos->where("tipo",">",2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item">
                            <a class="nav-link tipo-link <?php if($loop->first): ?> active <?php endif; ?>"
                               href="#"
                               data-ano-id="<?php echo e($value->id); ?>"
                               data-tipo-id="<?php echo e($item->id); ?>">
                ...
                <div class="mass-actions-bar" id="massActionsBar-<?php echo e($value->id); ?>" style="display: none;">
                    <div class="selection-info">
                        <i class="fa fa-check-square-o"></i>
                        <span id="selectedCount-<?php echo e($value->id); ?>">0</span> selecionado(s)
                    </div>
                    <div class="d-flex gap-2">
                        <button class="btn-mass" onclick="marcarTodosPagina('<?php echo e($value->id); ?>')">
                            <i class="fa fa-check-square-o"></i> Marcar todos da página
                        </button>
                        <button class="btn-mass" onclick="desmarcarTodosPagina('<?php echo e($value->id); ?>')">
                            <i class="fa fa-square-o"></i> Desmarcar todos
                        </button>
                        <button class="btn-mass btn-mass-danger" onclick="gerarSelecionados('<?php echo e($value->id); ?>')">
                ...
                <div class="card-tabela">
                    <div class="card-body">
                        <table class="table table-alunos" id="tabela-<?php echo e($value->id); ?>">
                            <thead>
                                <tr>
                                    <th width="50">
                                        <input type="checkbox" id="checkAllTopo-<?php echo e($value->id); ?>" class="checkbox-topo">
                                    </th>
            ...
            <?php else: ?>
                <div class="alert alert-info mt-3 text-center">
                    ...
                    Nenhum tipo de pagamento configurado para <?php echo e($value->anolectivo); ?>
        ...
        for(let i = 0; i < total; i++){
            ...
            try {
                let resultado = await $.ajax({
                    url: '<?php echo e(url("/RegistoAcademico/configuracoes/tabela-valores/registar_pagamentos")); ?>',
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/registoAcademico/TabelaValores/atribuir-alunos.blade.php ENDPATH**/ ?>