<?php $__env->startSection('title', 'Administração - Permissões do Sistema'); ?>
                ...
                <div class="card-modern animate-fadeInUp">
                    <div class="card-header">
                        <h3>
                            ...
                            <span class="badge-count"><?php echo e(count($Funcois)); ?> Funções</span>
                        </h3>
                    </div>
                    ...
                    <div class="card-body">
                        <!-- Alertas -->
                        <div class="col-12">
                            <?php echo $__env->make('include.mensage-alerta', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        ...
                        <div class="form-modern corpoAddicionarNovafuncao"
                             <?php if(isset($update)): ?> style="display: block;"
                             <?php else: ?> style="display: none;"
                             <?php endif; ?>>

                            <?php if(isset($update)): ?>
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('Admin.permisson.atualizar', $update->id)); ?>">
                                    <?php echo method_field('PUT'); ?>

                            <?php else: ?>
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('Admin.permissons.guardar')); ?>">
                            <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               autocomplete="on"
                                               <?php if(isset($update)): ?> value="<?php echo e($update->name); ?>"
                                               <?php else: ?> value="<?php echo e(old('nomeFuncao')); ?>"
                                               <?php endif; ?>>
                                ...
                                <div class="col-md-5 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               autocomplete="on"
                                               <?php if(isset($update)): ?> value="<?php echo e($update->label); ?>"
                                               <?php else: ?> value="<?php echo e(old('DiscricaoFuncao')); ?>"
                                               <?php endif; ?>>
                                ...
                                <div class="col-md-2 col-sm-12">
                                    <button type="submit" class="btn btn-primary-modern btn-modern" style="margin-top: 32px; width: 100%;">
                                        <i class="fa fa-<?php echo e(isset($update) ? 'save' : 'plus'); ?>"></i>
                                        <?php echo e(isset($update) ? 'Atualizar Função' : 'Criar Função'); ?>
                            ...
                            <div class="row mt-2">
                                <div class="col-12 text-right">
                                    <a href="<?php echo e(route('Admin.permissons.lista')); ?>" class="btn btn-secondary btn-modern">
                        ...
                        <!-- Lista de Permissões -->
                        <div class="row mt-4">
                            <?php $__empty_1 = true; $__currentLoopData = $Funcois; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Funcoes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-md-6 col-lg-4">
                                <div class="permission-card animate-scaleIn">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <p>
                                                ...
                                                <strong><?php echo e($Funcoes->label); ?></strong>
                                                <small class="badge-count"><?php echo e($Funcoes->permission->count()); ?> permissões</small>
                                            </p>
                                            <p>
                                                <?php if($Funcoes->name != 'Admin'): ?>
                                                <a href="<?php echo e(route('Admin.permissons.edit', $Funcoes->id)); ?>"
                                                   class="btn-edit"
                                                   data-tooltip="Editar função">
                                                    <i class="fa fa-edit"></i> Editar
                                                </a>
                                                <a href="<?php echo e(route('Admin.permissons.apagar', $Funcoes->id)); ?>"
                                                   class="btn-delete"
                                    ...
                                    <div class="card-body">
                                        <?php if($Funcoes->permission->count() > 0): ?>
                                        <ul style="list-style: none;">
                                            <?php $__currentLoopData = $Funcoes->permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permisso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <i class="fa fa-check-circle" style="color: #28a745;"></i>
                                                <?php echo e($permisso->label); ?>
                                    ...
                                    <div class="card-footer">
                                        <a class="btn btn-success-modern btn-modern"
                                           href="<?php echo e(route('Admin.permisson.papel', $Funcoes->id)); ?>"
...
<?php echo $__env->make('layouts.admin-Lti', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sgemozco/escolasaojoaopauloii.sgemoz.com/resources/views/Admin/ACL/Permissons-lista.blade.php ENDPATH**/ ?>