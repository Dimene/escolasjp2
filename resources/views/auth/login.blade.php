...
<head>
    ...
    <title>Login - {{ $conf->nome_Empresa ?? 'Sistema de Gestão Escolar' }}</title>
...
<body>
        ...
        <div class="login-card">
            <div class="login-header">
                <div class="logo-container">
                    <img src="{{ asset('storage/'.$subdomain.'/logoMarca/'.$conf->avatar) }}" alt="{{ $conf->nome_Empresa ?? 'Logo' }}">
                </div>
                <h3 class="system-name">Sistema de Gestão</h3>
                <p class="company-name">{{ $conf->nome_Empresa ?? 'Bem-vindo' }}</p>
            </div>
    ...
    <script src="{{ asset('Comfig/assets/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
