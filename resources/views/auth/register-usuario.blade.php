                                ...
                                <div class="form-group-modern">
                                    ...
                                    <select class="select-modern @error('categoria') is-invalid @enderror" name="categoria" required>
                                        ...
                                        @foreach ($categoria as $categoriaItem)
                                            <option value="{{ $categoriaItem->id }}" {{ old('categoria') == $categoriaItem->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <select class="select-modern @error('anolectivo_id') is-invalid @enderror" name="anolectivo_id" required>
                                        ...
                                        @foreach ($anolectivo as $anolectivoItem)
                                            <option value="{{ $anolectivoItem->id }}" {{ old('anolectivo_id') == $anolectivoItem->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <select class="select-modern @error('Nivel') is-invalid @enderror" name="Nivel" required>
                                        ...
                                        @foreach ($nivel as $nivelItem)
                                            <option value="{{ $nivelItem->id }}" {{ old('Nivel') == $nivelItem->id ? 'selected' : '' }}>
                                                {{ $nivelItem->Descricao }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <select class="select-modern @error('role') is-invalid @enderror" name="role" required>
                                        ...
                                        @foreach ($roles->all() as $rolesvalue)
                                            <option value="{{ $rolesvalue->id }}" {{ old('role') == $rolesvalue->id ? 'selected' : '' }}>
                                                {{ $rolesvalue->label }}
                                                @if($roles->find($rolesvalue->id)->permission->count())
                                                    ({{ $roles->find($rolesvalue->id)->permission->pluck('label')->implode(', ') }})
                                                @endif
                                            </option>
                                        @endforeach
                                    </select>
