...
@section('title', 'Gestão de Permissões do Sistema')
                ...
                <div class="card card-modern animate-fadeInUp">
                    ...
                    <div class="card-body" style="padding: 30px;">
                        ...
                        <form class="form-horizontal" role="form" method="POST"
                              action="{{ route('Admin.permisson.papel.Adicionar') }}"
                              enctype="multipart/form-data"
                              id="permissionForm">
                            @csrf

                            <div class="row">
                                @foreach ($modals as $index => $ide)
                                        ...
                                        <div class="module-card-header">
                                            <h5>
                                                ...
                                                <span class="count-badge">
                                                    {{ count($ide->permission) }} permissões
                                                </span>
                                            </h5>
                                        </div>
                                        <div class="module-card-body">
                                            <ul class="list-unstyled">
                                                @foreach ($ide->permission as $perm)
                                                    <li>
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox"
                                                                   ...
                                                                   @if(isset($Funcois[0]))
                                                                       @foreach ($Funcois[0]->permission as $permisso)
                                                                           @if ($permisso->id == $perm->id)
                                                                               checked
                                                                           @endif
                                                                       @endforeach
                                                                   @endif
                            ...
                            <input name="idFuncao" value="{{ $Funcois[0]->id ?? '' }}" type="hidden"/>
