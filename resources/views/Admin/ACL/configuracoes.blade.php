            ...
            <div class="container-fluid">
                        ...
                        <div class="col-md-4">
                            <ol class="breadcrumb breadcrumb-modern float-md-right">
                                <li class="breadcrumb-item">
                                    <a href="#">
                                        <i class="fas fa-home mr-1"></i> {{ session()->get('infosession')->TIpoSistema ?? 'Sistema' }}
                                    </a>
                                </li>
                ...
                <div class="card-modern fade-in">
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('Configuracoes.store') }}" enctype="multipart/form-data" id="configForm">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center slide-in">
                                    <div class="avatar-wrapper">
                                        <div class="avatar-preview" id="avatarPreview">
                                            <div class="avatar-img" style="background-image: url('{{ url("storage/$subdomain/logoMarca/$conf->avatar") }}');"></div>
                                ...
                                <div class="col-md-8 slide-in" style="animation-delay: 0.1s">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <input class="input-modern @error('Nome') is-invalid @enderror"
                                                       type="text" id="Nome" name="Nome"
                                                       value="{{ old('Nome', $conf->nome ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <input class="input-modern @error('NUit') is-invalid @enderror"
                                                       type="text" id="NUit" name="NUit"
                                                       value="{{ old('NUit', $conf->NUit ?? '') }}"
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <input class="input-modern @error('email') is-invalid @enderror"
                                               type="email" id="email" name="email"
                                               value="{{ old('email', $conf->Email ?? '') }}"
                                    ...
                                    <div class="form-group-modern">
                                        ...
                                        <input class="input-modern @error('endereco') is-invalid @enderror"
                                               type="text" id="endereco" name="endereco"
                                               value="{{ old('endereco', $conf->Localizacao ?? '') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <input class="input-modern @error('Contacto') is-invalid @enderror"
                                                       type="tel" id="Contacto" name="Contacto"
                                                       value="{{ old('Contacto', $conf->Contacto ?? '') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <input class="input-modern @error('Contacto2') is-invalid @enderror"
                                                       type="tel" id="Contacto2" name="Contacto2"
                                                       value="{{ old('Contacto2', $conf->Contacto2 ?? '') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <select class="select-modern @error('TIpoSistema') is-invalid @enderror"
                                                        id="TIpoSistema" name="TIpoSistema" required>
                                                    <option value="">Selecione o tipo de sistema...</option>
                                                    <option value="ERP" {{ old('TIpoSistema', $conf->TIpoSistema ?? '') == 'ERP' ? 'selected' : '' }}>
                                                        📊 ERP - Gestão Empresarial
                                                    </option>
                                                    <option value="CRM" {{ old('TIpoSistema', $conf->TIpoSistema ?? '') == 'CRM' ? 'selected' : '' }}>
                                                        🤝 CRM - Gestão de Clientes
                                                    </option>
                                                    <option value="POS" {{ old('TIpoSistema', $conf->TIpoSistema ?? '') == 'POS' ? 'selected' : '' }}>
                                                        🛒 POS - Ponto de Venda
                                                    </option>
                                                </select>
                                                @error('TIpoSistema')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group-modern">
                                                ...
                                                <input class="input-modern @error('nome_Empresa') is-invalid @enderror"
                                                       type="text" id="nome_Empresa" name="nome_Empresa"
                                                       value="{{ old('nome_Empresa', $conf->nome_Empresa ?? '') }}"
