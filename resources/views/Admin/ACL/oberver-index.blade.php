...
@section('title', 'Operações do Sistema')
        ...
        <div class="col-lg-3 mb-4">
            <div class="card-modern h-100">
                <div class="card-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 20px 20px 0 0;">
                    ...
                    <small>{{ $usuario->count() }} utilizadores registados</small>
                </div>
                <div class="users-list p-2">
                    @foreach ($usuario as $usuarioItem)
                        <div class="user-item d-flex align-items-center" data-id="{{ $usuarioItem->id }}" data-name="{{ $usuarioItem->name }}">
                            <div class="user-avatar me-3">
                                {{ strtoupper(substr($usuarioItem->name, 0, 1)) }}
                            </div>
                            <div class="flex-grow-1">
                                <div class="user-name">{{ $usuarioItem->name }}</div>
                                <div class="user-email">{{ $usuarioItem->email }}</div>
                            </div>
