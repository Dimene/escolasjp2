...
<section class="content">
    ...
    <div class="container-fluid animate-fadeInUp" style="animation-delay: 0.1s;">
        <form method="GET" action="{{ route('dashboard.financeiro') }}" class="card filter-card">
            <div class="card-body row">
                <div class="col-md-4">
                    <label><i class="fa fa-calendar"></i> <strong>Ano Lectivo</strong></label>
                    <select name="ano" class="form-control">
                        @foreach ($anolectivo as $a)
                            <option value="{{ $a->id }}" @selected($ano == $a->id)>📅 {{ $a->anolectivo }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4">
                    <label><i class="fa fa-calendar-range"></i> <strong>Data Início</strong></label>
                    <input type="date" name="data1" class="form-control" value="{{ $data1 }}">
                </div>
                <div class="col-md-4">
                    <label><i class="fa fa-calendar-range"></i> <strong>Data Fim</strong></label>
                    <input type="date" name="data2" class="form-control" value="{{ $data2 }}">
                </div>
                <div class="col-md-4">
                    <label><i class="fa fa-credit-card"></i> <strong>Tipo de Pagamento</strong></label>
                    <select name="tipo" class="form-control">
                        @foreach ($tipodepagamento as $tip)
                            <option value="{{ $tip->id }}" @selected($tipo == $tip->id)>{{ $tip->Descricao }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="info-box" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($totalGeral, 2, ',', '.') }} MT</span>
                        <small>{{ $pagamentos->count() }} transacções</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="info-box" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); color: white;">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($totalMultas, 2, ',', '.') }} MT</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="info-box" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white;">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $totalAlunos }}</span>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="info-box" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white;">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ number_format($mediaTicket, 2, ',', '.') }} MT</span>
        ...
        @forelse ($groupedByDate as $dateKey => $itemsByDate)
            ...
            <div class="date-card animate__animated animate__fadeInUp">
                ...
                <div class="card-body p-4">
                    ...
                    @php $groupedByClass = $itemsByDate->groupBy('classe'); @endphp
                    ...
                    @foreach ($groupedByClass as $classeNome => $itemsByClass)
                        ...
                        <div class="class-card mb-4">
                            <div class="class-header d-flex justify-content-between align-items-center" data-toggle-class="{{ $classSlug }}">
                                <h5 class="mb-0"><i class="fa fa-chalkboard-user me-2"></i> {{ $classeNome }}</h5>
                                <span><i class="fa fa-chevron-right toggle-icon" id="icon-{{ $classSlug }}"></i></span>
                            </div>
                            <div id="class-content-{{ $classSlug }}" style="display: none;">
                                @php $groupedByMethod = $itemsByClass->groupBy('metodoPagDesc'); @endphp
                                    ...
                                    <div class="method-group">
                                        <div class="method-header d-flex justify-content-between align-items-center" data-toggle-method="{{ $methodSlug }}">
                                            ...
                                            <div>
                                                ...
                                                <i class="fa fa-chevron-down toggle-icon-method ms-2" id="icon-method-{{ $methodSlug }}"></i>
                                            </div>
                                        </div>
                                            ...
                                            @foreach ($itemsByMethod as $pag)
                                                <div class="student-item">
                                                    <div>
                                                        ...
                                                        @if(($pag->Multa ?? 0) > 0)
                                                            <span class="badge bg-warning text-dark ms-2"><i class="fa fa-exclamation-triangle me-1"></i> Multa: {{ number_format($pag->Multa,2,',','.') }} MT</span>
                                                        @endif
                                                    </div>
                                                    <div>
                                ...
                                <div class="p-3 bg-light mx-3 mb-3 rounded" style="border-left: 4px solid #1e4663;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong><i class="fa fa-chart-simple me-2"></i>Total da Classe {{ $classeNome }}</strong>
                ...
                <div class="row text-center mt-3">
                    <div class="col-md-4 mb-2">
                        <div class="border rounded p-3 bg-white text-dark">
                            ...
                            <h4 class="mb-0">{{ number_format($pagamentos->sum('valorDescricao'),2,',','.') }} MT</h4>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="border rounded p-3 bg-white text-dark">
                            <small>Total de Multas</small>
                            <h4 class="mb-0 text-danger">{{ number_format($pagamentos->sum('Multa'),2,',','.') }} MT</h4>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="border rounded p-3 bg-warning">
                            <small>TOTAL GERAL COM MULTAS</small>
                            <h4 class="mb-0">{{ number_format($pagamentos->sum('valorDescricao') + $pagamentos->sum('Multa'),2,',','.') }} MT</h4>
                        </div>
                    </div>
                </div>
            </div>
