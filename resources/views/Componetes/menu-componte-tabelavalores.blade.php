...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link
                    @if ($_SERVER['REQUEST_URI'] == '/RegistoAcademico/TabelaValores/show' ||
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if ($_SERVER['REQUEST_URI'] == '/RegistoAcademico/TabelaValores/create')
                        active
                    @endif"
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if ($_SERVER['REQUEST_URI'] == '/RegistoAcademico/metodosdepagamentos/NovoPagamento')
                        active
                    @endif"
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if ($_SERVER['REQUEST_URI'] == '/RegistoAcademico/metodosdepagamentos/AtribuirAlunos')
                        active
                    @endif"
