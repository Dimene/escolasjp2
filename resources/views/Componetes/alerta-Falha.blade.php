...
<div class="breadcrumb-modern animate-fadeInUp">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><i class="fa fa-pencil"></i> <b>{{ $tipopauta ?? 'Pauta' }}</b></li>
    </ol>
</div>
...
<div class="message-wrapper">
    <div class="message-box">
        ...
        <div class="message-icon {{ $cores[$tipo] }}">
            <i class="fa {{ $icones[$tipo] }} text-white"></i>
        </div>

        <h2 class="message-title">{{ $titulos[$tipo] }}</h2>
        ...
        <div>
            <a href="{{ url()->previous() }}" class="btn-custom btn-secondary">
                <i class="fa fa-arrow-left"></i> Voltar
            </a>
            <a href="{{ route('home') }}" class="btn-custom btn-primary ms-2">
