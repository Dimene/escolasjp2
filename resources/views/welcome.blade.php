...
<head>
    ...
    <title>{{ $conf->nome_Empresa ?? 'Instituição de Ensino' }} | {{ $conf->TIpoSistema ?? 'Sistema de Gestão Escolar' }}</title>
...
<body>
    ...
    <div class="hero-section">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <div class="hero-content fade-in-up">
                <h1 class="hero-title">{{ $conf->nome_Empresa ?? 'Excelência em Educação' }}</h1>
                <p class="hero-subtitle">{{ $conf->TIpoSistema ?? 'Formando líderes para o futuro' }}</p>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        ...
        <div class="logo-section fade-in-up">
            <div class="logo-wrapper">
                <img src="{{ asset('storage/'.$subdomain.'/logoMarca/'.$conf->avatar) }}" alt="{{ $conf->nome_Empresa }}" class="logo-image">
                <h3 class="institution-name">{{ $conf->nome_Empresa }}</h3>
                <p class="institution-type">{{ $conf->TIpoSistema }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <p>&copy; {{ date('Y') }} {{ $conf->nome_Empresa }}. Todos os direitos reservados.</p>
