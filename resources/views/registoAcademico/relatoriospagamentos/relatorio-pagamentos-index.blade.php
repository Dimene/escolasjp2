         ...
         var ano= $('[name="anoLectivo"]').val();
          ...
          var date2 = new Date(data2);
            ...
            console.log(data2send);
                ...
                $.ajax({
                    url:'/aluno/mensalidade/Relatorio/pagamentos/'+ano+'/'+classe+'/'+data1send+'/'+data2send+'',
                    type:'GET',
...
var date2 = new Date(data2);
  ...
  console.log(data2send);
      ...
      $.ajax({
          url:'/aluno/mensalidade/Relatorio/pagamentosPrint/'+ano+'/'+classe+'/'+data1send+'/'+data2send+'',
          type:'GET',
          success: function(data){
