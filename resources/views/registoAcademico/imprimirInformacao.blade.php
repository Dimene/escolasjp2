...
<tr><td>Turma</td><td style="width:8%"> </td></tr>
    ...
    <div class="a4-column">
        ...
        <div class="header">
  <div class="logom">
 <img src="{{ asset('logoTipo/simboloR.png') }}" style="
  width: 20mm;
  height: 20mm;
  display: flex;
  justify-content: center;
...
">
        ...
        <div class="photo-container">
            @if(!empty($aluno->avatar))
                <img src="{{ asset('storage/' . $subdomain . '/fotoAluno/' . $aluno->avatar) }}"
         alt="Foto do aluno"
        ...
        @if(!empty($conf->avatar))
          <img src="{{ asset('storage/logoMarca/' . $conf->avatar) }}" alt="{{ $conf->nome }}">
        @else
        ...
        @endif
            ...
            <div class="row">
               {{-- ?\ <div class="label">Estabelecimento:</div> --}}
                ...
                <div class="field-value">{{ $conf->nome ?? 'ESCOLA' }}</div>
            </div>
            <div class="row">
                <div class="field-value">
                   <b>Provincia:</b> {{ $conf->Provincia ?? '' }}
                    <b>Distrito:</b> {{ $conf->Distrito ?? '' }}
                     <b>Bairro:</b>{{ $conf->Localizacao ?? '' }}
                </div>
            </div>
            <div class="row">
        ...
        <div class="section">
            ...
            <div class="data-field">
                ...
                <div class="field-value text-uppercase bold">{{ $processo_id ?? $alunoId ?? '' }}</div>
            </div>

            <div class="data-field">
                <div class="field-label">Nome completo:</div>
                <div class="field-value text-uppercase bold">{{ $aluno->nome ?? '' }}</div>
            </div>
            ...
            <div class="data-field">
                ...
                <div class="field-value" style="min-width: 20mm;">{{ isset($aluno->dataNascimento) ? Carbon::parse($aluno->dataNascimento)->age . ' anos' : '' }}</div>
            </div>
            ...
            <div class="data-field">
                ...
                <div class="field-value" style="min-width: 15mm;">{{ $aluno->sexo ?? '' }}</div>
            </div>
         ...
         <div class="section">
            ...
            <div class="data-field">
                ...
                <div class="field-value text-uppercase bold">{{ $aluno->encaregado->nome ?? '' }}</div>
            ...
            <div class="data-field">
                ...
                <div class="field-value" style="min-width: 25mm;">{{ $aluno->encaregado->religiao->nome ?? '' }}</div>
            </div>
        </div>
