...
<head>
    ...
    <title>Perfil do Aluno - {{ $aluno->nome }}</title>
    <meta name="description" content="Perfil completo do aluno {{ $aluno->nome }}">
        ...
        <div class="row">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="avatar-container mb-2">
                            ...
                            <div class="avatar-overlay">
                                <h6 class="mb-1 text-truncate">{{ $aluno->nome }}</h6>
                                <div class="avatar-id">ID: {{ $aluno->id }}</div>
                                <small class="d-block mt-1 opacity-75">{{ $aluno->classe }}</small>
                            </div>
                        </div>
            ...
            <div class="col conteudo-principal">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="h3 mb-1">{{ $aluno->nome }}</h1>
                        <p class="text-muted mb-0">
                            <i class="fas fa-graduation-cap me-1"></i>
                            {{ $aluno->classe }} • {{ $tipoAluno }}
                        </p>
                    </div>
                    <div class="d-flex gap-2">
                        <span class="badge {{ $tipoBadgeClass }} px-3 py-2">
                            {{ $tipoAluno }}
                        </span>
                    </div>
                </div>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pagamentos-tab" data-bs-toggle="tab" data-bs-target="#pagamentos"
                            ...
                            @if (count($pagamentos) > 0)
                                <span class="badge bg-info ms-2">{{ count($dadosmatricula) }}</span>
                            @endif
                        </button>
                    </li>
                </ul>
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $dataNascimentoFormatada }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->classe }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-info-circle"></i> Estado
                                            </div>
                                            <div class="info-value">{{ $statusTexto }}</div>
                                        </div>
                                        @if (isset($aluno->anolectivo))
                                            <div class="info-item">
                                                <div class="info-label">
                                                    <i class="fas fa-calendar-alt"></i> Ano Lectivo
                                                </div>
                                                <div class="info-value">{{ $aluno->anolectivo }}</div>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->Endereco ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-road"></i> Rua/Avenida
                                            </div>
                                            <div class="info-value">{{ $aluno->RuaAvenida ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-home"></i> Casa
                                            </div>
                                            <div class="info-value">{{ $aluno->Casa ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-th-large"></i> Quarteirão
                                            </div>
                                            <div class="info-value">{{ $aluno->Quarterao ?? 'Não informado' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->Encaregado ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-handshake me-2"></i>Parentesco
                                            </div>
                                            <div class="info-value">{{ $aluno->GrauParentesco ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-briefcase me-2"></i>Profissão
                                            </div>
                                            <div class="info-value">{{ $aluno->profissaoEncaregado ?? 'Não informado' }}</div>
                                        </div>
                                        <div class="info-item">
                                            <div class="info-label">
                                                <i class="fas fa-pray me-2"></i>Religião
                                            </div>
                                            <div class="info-value">{{ $aluno->Religiao_Encaregado ?? 'Não informado' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->nome_pai ?? 'Não informado' }}</div>
                                        </div>

                                      @foreach ($contactos->where("Encaregado_id", $aluno->id_pai) as $i => $contactoV)

    @if (!empty($contactoV->Descricao))
        <div class="info-item">
            <div class="info-label">
...
@endforeach
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->pai_profissao ?? 'Não informado' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->nome_mae ?? 'Não informado' }}</div>
                                        </div>
                                        @foreach ($contactos->where("Encaregado_id", $aluno->id_mae) as $i => $contactoV)
...
@endforeach
                                        <div class="info-item">
                                            ...
                                            <div class="info-value">{{ $aluno->mae_profissao ?? 'Não informado' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="info-card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            @foreach ($contactos->where("Encaregado_id",$aluno->Encaregado_id) as $i=>$contacto )



                                                @if ($contacto->Descricao)
                                                    <div class="col-md-4">
                                                        <div class="info-item">
                                                            <div class="info-label">
                                                                <i class="fas fa-phone"></i> Contacto{{ $i }}
                                                            </div>
                                                            <div class="info-value">{{$contacto->Descricao}}</div>
                                                        </div>
                                                    </div>
                                                @endif
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-light">
                                            <td colspan="6" class="text-center py-3">
                                                <strong class="text-primary">{{ $aluno->tipopagamentoNome }}</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>{{ $aluno->mesNome }}</td>
                                            <td>{{ number_format($aluno->valorDescricao, 2, ',', '.') }} MT</td>
                                            <td>{{ number_format($aluno->Multa, 2, ',', '.') }} MT</td>
                                            <td>{{ $aluno->metodo_pagamento_desc }}</td>
                                            <td><code>{{ $aluno->referencia }}</code></td>
                                            <td>
                                                <span class="badge {{ $aluno->Estado_Classe == 'Pago' ? 'badge-pago' : 'badge-pendente' }}">
                                                    {{ $aluno->Estado_Classe }}
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        @foreach ($dadosmatricula as $pg)
                                            <tr class="table-light">
                                                <td colspan="6" class="text-center py-3">
                                                    <strong class="text-primary">{{ $pg['Descrica'] ?? 'N/A' }}</strong>
                                                </td>
                                            </tr>
                                            @foreach ($pg['pagasNodia']->sortBy('mes_id') as $item)
                                                <tr>
                                                    <td>{{ $item->mes }}</td>
                                                    <td>{{ number_format($item->valorDescricao, 2, ',', '.') }} MT</td>
                                                    <td>{{ number_format($item->Multa, 2, ',', '.') }} MT</td>
                                                    <td>{{ $item->metodo_pagamento }}</td>
                                                    <td><code>{{ $item->referencia }}</code></td>
                                                    <td>
                                                        <span class="badge {{ $item->Estado == 'Pago' ? 'badge-pago' : 'badge-pendente' }}">
                                                            {{ $item->Estado }}
                                                        </span>
                                                    </td>
                                                </tr>
...
const dadosmatricula = @json($dadosmatricula);
const dadosMes = @json($dadosMes);
