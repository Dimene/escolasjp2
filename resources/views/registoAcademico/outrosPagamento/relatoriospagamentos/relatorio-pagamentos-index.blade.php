...
<label>Escolha o tipo de pagamento </label>
            <div class="form-group">
                ...
                onchange="adicionardadostabela()" name="tipodepagamento">
                   ...
                   <option value="{{$tipoPagamentoItem->id }}">{{ $tipoPagamentoItem->Descricao }}</option>
                   @endcan
                   @endforeach
          ...
          var date2 = new Date(data2);
            ...
            console.log(data2send);
                ...
                $.ajax({
					...
					beforeSend: function(){
					  $(".conteudo").html(' <img src="{{ asset('imageproceaament/loading.gif')}}"  style=" margin-left:40%;width:200px;height:200px">');
					}
