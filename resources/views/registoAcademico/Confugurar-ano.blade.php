...
@section('title', 'Configuração de Ano Lectivo')
@section('content')
    ...
    <div class="row">
                        ...
                        @foreach ($anoLectivo as $anoLectivoItem)
                            <div class="list-group-item-modern">
                                ...
                                <div class="action-badges">
                                    <a href="{{ Route('ano.edit', $anoLectivoItem->id) }}" class="badge-action badge-edit">
                                        <i class="fa fa-edit"></i> Editar
                                    </a>
                                    <a href="{{ Route('ano.show', $anoLectivoItem->id) }}" class="badge-action badge-delete">
        ...
        <div class="col-lg-8">
            <div class="form-section">
                ...
                <form action="{{ Route('ano.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <select class="select-modern" name="anolectivo" required>
                                    @for($i = 0; $i < 10; $i++)
                                        <option value="{{ 2020 + $i }}" @if(2020 + $i == date('Y')) selected @endif>
                                            {{ 2020 + $i }}
                                        </option>
                                    @endfor
                                </select>
