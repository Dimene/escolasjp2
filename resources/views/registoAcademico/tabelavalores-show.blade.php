                                ...
                                <tbody class="body">
                                    ...
                                    <tr data-id="{{ $colecaoV['id'] }}">
                                            ...
                                            <div style="max-width: 250px;">
                                                ...
                                                @foreach($classes as $classe)
                                                    <span class="badge-class">
                                                        <i class="fa fa-graduation-cap mr-1"></i>{{ $classe }}
                                                    </span>
                                                @endforeach
                                            </div>
                                        </td>
                                        ...
                                        <td class="action-btns">
                                            ...
                                            <a class="btn btn-outline-primary  btn-sm btn-edit"   href="/RegistoAcademico/TabelaValores/{{$colecaoV['id']}}/edit"  title="{{$colecaoV['id']}}" > <i class="fa fa-edit"></i></a>
  <button class="btn btn-outline-danger btn-sm btn-apagar"  title="{{$colecaoV['id']}}" > <i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
