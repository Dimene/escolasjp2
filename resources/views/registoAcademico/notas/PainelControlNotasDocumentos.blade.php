                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="form-control controledeclasseano" name="anolectivo" id="anolectivo">
                                        @foreach ($anolectivo as $ano)
                                            <option value="{{ $ano->id }}" @if($ano->anolectivo == Carbon\Carbon::now()->format("Y")) selected @endif>
                                                {{ $ano->anolectivo }}
                                            </option>
                                        @endforeach
                                    </select>
...
<script>
let trimestres = @json($trimestres);
let classeGet = @json($classe);
...
$(document).on("click", ".botaoImpeimircertificado", function () {
    ...
    let urlBase = "{{ route('notas.declaracao', [':idaluno',':trimestre',':classe',':anolectivo']) }}";
...
function getpainelAlunos(ano, classe, tipoDocu) {
    let urlBase = "{{ route('notas.ListadosAlunos', [':ano',':classe',':tipoDocu']) }}";
