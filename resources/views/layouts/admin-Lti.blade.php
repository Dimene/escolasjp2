...
<head>
    ...
    <title>Sistema de Gestão Escolar | @yield('title')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('storage/'.$subdomain.'/logoMarca/' . $avatar) }}" type="image/png" sizes="32x32">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed {{ $menuCollapsed ? 'sidebar-collapse' : '' }}">
    <div class="wrapper">
        <!-- Navbar -->
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        ...
                        <span class="d-none d-md-inline ml-1">{{ $dados ?? 'Usuário' }}</span>
                    </a>
        ...
        <aside class="main-sidebar elevation-2">
            <a href="/" class="brand-link">
                <img src="{{ asset('storage/'.$subdomain.'/logoMarca/' . $avatar) }}" alt="Logo"
    ...
    <script src="{{ asset('bootstrap-daterangepicker-master/moment.js') }}"></script>
